...
const Section8 = () => {
    return (
        <div className='h-[60vh] md:h-[60vh] w-full flex flex-col justify-center items-center gap-[10vh] lg:mt-[10vh]'>
            <h2 className='text-5xl sm:text-6xl md:text-8xl lg:text-9xl font-extrabold w-full text-center uppercase'>
            ...
            <h2 className='text-3 md:text-xl lg:text-6xl font-bold w-full text-center'>
